...
class SetDisplayModeDialog extends React.Component {
  ...
  updateDisplayMode() {
    ...
    const right = this.state.rightDisplay; // update display mode in the parent component
  ...
  render() {
    ...
    return React.createElement(Dialog, {
      ...
      className: "set-display-mode__switches"
    }, React.createElement(RadioGroup, {
      header: "\u663E\u793A\u6A21\u5F0F"
    }, displayModeItems), React.createElement(RadioGroup, {
      header: "\u5DE6\u4FA7"
    }, leftDisplay), React.createElement(RadioGroup, {
      header: "\u53F3\u4FA7"
